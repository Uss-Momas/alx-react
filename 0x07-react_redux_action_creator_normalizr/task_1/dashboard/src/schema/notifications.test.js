...
describe('Test for notifications.js', () => {
    it("Verify if returns the correct list", () => {
    ...
    it("Verify if normalized data has correct data", () => {
        const result = [
    ...
    it("Verify correct user in normalized data", () => {
        const user = {
            age: 25,
    ...
    it('Verify if have a correct message entity', () => {
        const message = {
    ...
    it('Should have a correct notifications entity', () => {
        ...
        expect(
            normalizedData.entities.notification['5debd7642e815cd350407777']
